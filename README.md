...
```javascript
import constants from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-complex64@v0.2.3-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { NAN, NUM_BYTES, ZERO } from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-complex64@v0.2.3-deno/mod.js';
```
