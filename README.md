...
```javascript
import constants from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-complex64@v0.1.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { NUM_BYTES } from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-complex64@v0.1.1-deno/mod.js';
```
